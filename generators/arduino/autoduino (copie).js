...
Blockly.Arduino.autoduino_motor = function() {
  ...
  if(dropdown_direction==="forward"){
    code = code + setAutoduinoOutput(dropdown_pin1, "HIGH");
    code = code + setAutoduinoOutput(dropdown_pin2, "LOW");
  } else if (dropdown_direction==="right") {
    code = code + setAutoduinoOutput(dropdown_pin1, "LOW");
    code = code + setAutoduinoOutput(dropdown_pin2, "HIGH");
...
Blockly.Arduino.autoduino_dual_motor = function() {
  ...
  if(dropdown_direction==="forward"){
    code = code + setAutoduinoOutput(dropdown_pin1, "HIGH");
    code = code + setAutoduinoOutput(dropdown_pin2, "LOW");
    code = code + setAutoduinoOutput(dropdown_pin3, "LOW");
    code = code + setAutoduinoOutput(dropdown_pin4, "HIGH");
  } else if (dropdown_direction==="right") {
    code = code + setAutoduinoOutput(dropdown_pin1, "LOW");
    code = code + setAutoduinoOutput(dropdown_pin2, "HIGH");
    code = code + setAutoduinoOutput(dropdown_pin3, "LOW");
    ...
    code = code + setAutoduinoOutput(dropdown_pin1, "HIGH");
    code = code + setAutoduinoOutput(dropdown_pin2, "LOW");
    code = code + setAutoduinoOutput(dropdown_pin3, "HIGH");
    code = code + setAutoduinoOutput(dropdown_pin4, "LOW");
  } else if (dropdown_direction==="backward"){
    code = code + setAutoduinoOutput(dropdown_pin1, "LOW");
    code = code + setAutoduinoOutput(dropdown_pin2, "HIGH");
    code = code + setAutoduinoOutput(dropdown_pin3, "HIGH");
